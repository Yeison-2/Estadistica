...
- **Desviación Estándar**: {desviacion_estandar_app} En promedio, el tiempo de uso de aplicaciones móviles varía en 177.20 minutos respecto a la media.
- **Coeficiente de Variación**: {coef_variacion_app} La desviación estándar es el 65% de la media, lo que muestra una alta variabilidad relativa en el tiempo de uso.
- **Asimetría**: {asimetria_app} La distribución de los datos tiene una ligera asimetría positiva, indicando que hay más usuarios con tiempos de uso por encima de la media.
...
- **Desviación Estándar**: {desviacion_estandar_comportamiento} En promedio, el comportamiento del usuario varía en 1.40 unidades respecto a la media.
- **Coeficiente de Variación**: {coef_variacion_comportamiento} La desviación estándar es el 47% de la media, lo que muestra una variabilidad relativa moderada.
- **Asimetría**: {asimetria_comportamiento} La distribución de los datos es casi simétrica.
